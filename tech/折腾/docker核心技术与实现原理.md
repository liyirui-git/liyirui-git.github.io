...
![docker-logo](docker核心技术与实现原理.assets/2017-11-30-docker-logo.png)
...
![docker-core-techs](docker核心技术与实现原理.assets/2017-11-30-docker-core-techs.png)
...
![multiple-servers-on-linux](docker核心技术与实现原理.assets/2017-11-30-multiple-servers-on-linux.png)
...
![linux-processes](docker核心技术与实现原理.assets/2017-11-30-linux-processes.png)
...
![docker-process-group](docker核心技术与实现原理.assets/2017-11-30-docker-process-group.png)
...
![docker-network](docker核心技术与实现原理.assets/2017-11-30-docker-network.png)
...
![docker-network-topology](docker核心技术与实现原理.assets/2017-11-30-docker-network-topology.png)
...
![docker-network-forward](docker核心技术与实现原理.assets/2017-11-30-docker-network-forward.png)
...
![container-network-model](docker核心技术与实现原理.assets/2017-11-30-container-network-model.png)
...
![libcontainer-filesystem](docker核心技术与实现原理.assets/2017-11-30-libcontainer-filesystem.png)

想要正常启动一个容器就需要在 rootfs 中挂载以上的几个特定的目录，除了上述的几个目录需要挂载之外我们还需要建立一些符号链接保证系统 IO 不会出现问题。

![libcontainer-symlinks-and-io](docker核心技术与实现原理.assets/2017-11-30-libcontainer-symlinks-and-io.png)
...
![docker-shared-resources](docker核心技术与实现原理.assets/2017-11-30-docker-shared-resources.png)

如果其中的某一个容器正在执行 CPU  密集型的任务，那么就会影响其他容器中任务的性能与执行效率，导致多个容器相互影响并且抢占资源。如何对多个容器的资源使用进行限制就成了解决进程虚拟资源隔离之后的主要问题，而 Control Groups（简称 CGroups）就是能够隔离宿主机器上的物理资源，例如 CPU、内存、磁盘 I/O 和网络带宽。

每一个 CGroup 都是一组被相同的标准和参数限制的进程，不同的 CGroup 之间是有层级关系的，也就是说它们之间可以从父类继承一些用于限制资源使用的标准和参数。

![cgroups-inheritance](docker核心技术与实现原理.assets/2017-11-30-cgroups-inheritance.png)

Linux 的 CGroup 能够为一组进程分配资源，也就是我们在上面提到的 CPU、内存、网络带宽等资源，通过对资源的分配，CGroup 能够提供以下的几种功能：

![groups-features](docker核心技术与实现原理.assets/2017-11-30-groups-features.png)
...
![linux-cgroups](docker核心技术与实现原理.assets/2017-11-30-linux-cgroups.png)
...
![docker-container-laye](docker核心技术与实现原理.assets/2017-11-30-docker-container-layer.png)

当镜像被 `docker run` 命令创建时就会在镜像的最上层添加一个可写的层，也就是容器层，所有对于运行时容器的修改其实都是对这个容器读写层的修改。

容器和镜像的区别就在于，所有的镜像都是只读的，而每一个容器其实等于镜像加上一个可读写的层，也就是同一个镜像可以对应多个容器。

![docker-images-and-container](docker核心技术与实现原理.assets/2017-12-06-docker-images-and-container.png)
...
![docker-aufs](docker核心技术与实现原理.assets/2017-11-30-docker-aufs.png)
...
![docker-filesystems](docker核心技术与实现原理.assets/2017-11-30-docker-filesystems.png)
...
![docker-storage-driver](docker核心技术与实现原理.assets/2017-11-30-docker-storage-driver.png)
